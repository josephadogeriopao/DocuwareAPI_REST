...
namespace OPAOWebService.ConfigTool
{
    ...
    {
        public static void RunManualMode(IDataProtector protector)
        {
            Console.WriteLine("\n--- Manual Mode ---");
        ...
        public static void RunBulkMode(IDataProtector protector)
        {
            ...
            string projectPath = Path.GetFullPath(Path.Combine(executionDir, "..", "..", "..", ".."));
        ...
        public static void RunDecryptionMode(IDataProtector protector)
        {
            ...
            try
            {
                string decrypted = protector.Unprotect(input);
                Console.ForegroundColor = ConsoleColor.Green;
            ...
            catch (CryptographicException)
            {
                ...
                Console.WriteLine("\n❌ Decryption failed! The string was likely encrypted with a different key or purpose string.");
            }
            finally
            {
                Console.ResetColor();
